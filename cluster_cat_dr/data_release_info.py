...
# dictionary with all columns for the DR.
# each entry is named after the column name found in the raw tables.
identifier_col_info = {
...
sed_tab_1_info = {
    'SED_TREEFIT_CATEGORY': {
        'col_name': 'SED_TREEFIT_CATEGORY',
        'unit': None,
        'unit_str': 'str',
        'doc_comment': 'Category used to assign the model parameter grid for SED-TreeFit analysis. '
                       'Possible values can be ‘YNO’, ‘UNCHANGED’, or ‘OGC’',
        'tab_comment': ''
        },
    ...
    'SEDfix_mass_limlo' : {
        'col_name': 'PHANGS_MASS_LIMLO',
        'unit': None,
        'unit_str': 'float',
        'doc_comment': '',
        'tab_comment': '',
    },
    'SEDfix_likelihood_norm' : {
        'col_name': 'PHANGS_AGE_MINCHISQ',
        'unit': None,
        'unit_str': 'float',
        'doc_comment': '',
        'tab_comment': '',
...
#
#     Myr Age corresponding to SED-TreeFit analysis.
#
# mag Reddening E(B-V) corresponding to SED-TreeFit analysis.
#
#  M⊙Stellar mass corresponding to SED-TreeFit analysis.
#
#  Myr Upper limit on age corresponding to SED-TreeFit analysis.
#
# Myr Lower limit on age corresponding to SED-TreeFit analysis.
#
#  mag Upper limit on reddening E(B-V) corresponding to SED-TreeFit analysis.
#
#  mag Lower limit on reddening E(B-V) corresponding to SED-TreeFit analysis.
#
#  M⊙Upper limit on stellar mass corresponding to SED-TreeFit analysis.
#
# M⊙Lower limit on stellar mass corresponding to SED-TreeFit analysis.
#
#  Myr Cluster age corresponding to SED fit with minimum reduced χ2
# PHANGS AGE MINCHISQ ERR Myr Uncertainty of age from minimum reduced χ2
# PHANGS MASS MINCHISQ M⊙Cluster mass corresponding to SED fit with minimum reduced χ2
# PHANGS MASS MINCHISQ ERR M⊙Uncertainty of mass from minimum reduced χ2
# PHANGS EBV MINCHISQ mag Cluster reddening E(B-V) corresponding to SED fit with minimum
# reduced χ2
# PHANGS EBV MINCHISQ ERR mag Uncertainty of E(B-V) from minimum reduced χ2
# PHANGS REDUCEDCHISQ MINCHISQ float The reduced χ2 value from the SED fit
# PHANGS DMPC Mpc Distance of host galaxy used for SED-TreeFit analysis
# PHANGS DERR Mpc Uncertainty on distance
#
#
